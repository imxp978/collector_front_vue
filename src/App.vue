      ...
      <div class="row">
        <div class="col-1 h-100 bg-dark bg-gradient position-fixed">
          <div class="row mt-4  ">
            ...
            <RouterLink class="col-12 link text-white py-3 border-bottom border-secondary text-center" to="/stamp"><h3><i class="bi bi-postage-heart-fill"></i></h3></RouterLink>
            <RouterLink class="col-12 link text-white py-3 border-bottom border-secondary text-center" to="/envelopes"><h3><i class="bi bi-envelope-fill"></i></h3></RouterLink>
          </div>
        </div>
        <div class="col-1"></div>
